...
HD_PWD='D:/Verilog code/kyber_ntt_fpga/kyber_ntt_fpga/kyber_ntt_fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kyber_ntt_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kyber_ntt_wrapper.tcl -notrace
