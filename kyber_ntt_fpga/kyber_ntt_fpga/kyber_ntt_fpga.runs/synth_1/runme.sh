...
HD_PWD='D:/Verilog code/kyber_ntt_fpga/kyber_ntt_fpga/kyber_ntt_fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kyber_ntt_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kyber_ntt_wrapper.tcl
